...
# Disabled numba because it is incompatible with Python 3.12
def jit(*args, **kwargs):
    def decorator(func):
        return func
    return decorator
...
def my_njit(func: T) -> T:
    # In ROS2 Jazzy (Python 3.12) numba is not available.
    # This wrapper simply returns the original function.
    return func
